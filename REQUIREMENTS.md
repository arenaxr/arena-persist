...
| [cascade.js](cascade.js) | Bounded breadth-first descendant delete walk | `deleteObjectAndDescendants`, `cascadeDeleteDescendants`, `buildForget`, `MAX_CASCADE_NODES`, `MAX_CASCADE_DEPTH` |
